...
color waveforms, see TODO: Section 6.10 for details.
...
are compatible with original nexus players. See TODO: Section 6.12 for
how you can obtain a newer format which includes hot cue colors, DJ-
assigned comment text, and hot cues beyond C.
...
loaded, is 8 which is what we expect for a graphical data request.
