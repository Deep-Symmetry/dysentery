...
_D~d~_ reflects the player number on which the track is supposed to be
loaded. The number is 0-based so for instance when loading a track on
player 1, this value will be `00`.
