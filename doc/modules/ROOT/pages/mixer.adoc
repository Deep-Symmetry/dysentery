...
(draw-box :text (hex-text "02" :font-weight "bold"))
(draw-box :span 2 :text (label-text "len" "p"))
(draw-box :text (label-text "N"))
(draw-box :text (hex-text "02"))
(draw-box :span 6 :text (plain-text "MAC address"))
(next-row)
----
...
(draw-box :text (hex-text "02" :font-weight "bold"))
(draw-box :span 2 :text (label-text "len" "p"))
(draw-box :span 4 :text (plain-text "IP address"))
(draw-box :span 6 :text (plain-text "MAC address"))
(draw-box :text (label-text "D"))
(draw-box :text (label-text "N"))
(next-row)

(draw-box :text (hex-text "02") :borders #{:left :top :bottom})
(draw-box :text (hex-text "01") :borders #{:right :top :bottom})
(next-row)
----
...
(draw-box :text (hex-text "02" :font-weight "bold"))
(draw-box :span 2 :text (label-text "len" "p"))
(draw-box :text (hex-text "01") :borders #{:left :top :bottom})
  (doseq [val ["02" "00"]]
    (draw-box :text (hex-text val) :borders #{:top :bottom}))
(draw-box :text (hex-text "26") :borders #{:right :top :bottom})
(draw-box :text (label-text "D"))
(draw-box :text (label-text "N"))
(next-row)
----
