...
It seems to no longer be https://web.archive.org/web/20160812170057/http://www.ubiquitous.co.jp/en/products/db/md/devicesql/[available], which is no surprise as even Alpha Theta have moved on to (encrypted) SQLite.
