...
\begin{figure}
  \begin{bytefield}[bitwidth=1.9em, leftcurly=., leftcurlyspace=0pt, boxformatting={\baselinealign}]{16}
    ...
    \begin{leftwordgroup}{\tiny\bfseries 00}
      ...
      \bitbox{1}{\tt 11} & \bitbox{4}{\tt 872349ae} & \bitbox{1}{\tt 11} & \bitbox{4}{\tt fffffffe} &
      \bitbox{1}{\tt 10} & \bitbox{2}{\tt 4000} & \bitbox{1}{\tt 0f} & \bitbox{1}{\tt 02} &
      \bitbox{1}{\tt 14}
    \end{leftwordgroup} \\

    \begin{leftwordgroup}{\tiny\bfseries 10}
      \bitbox{4}{{\tt 0000000c}\small{ (12)}} & \bitboxes*{1}{{\tt 06} {\tt 06} {\tt 00} {\tt 00}
        {\tt 00} {\tt 00} {\tt 00} {\tt 00} {\tt 00} {\tt 00} {\tt 00} {\tt 00}}
    \end{leftwordgroup} \\
...
\begin{figure}
  \begin{bytefield}[bitwidth=1.9em, leftcurly=., leftcurlyspace=0pt, boxformatting={\baselinealign}]{16}
    ...
    \begin{leftwordgroup}{\tiny\bfseries 00}
      ...
      \bitbox{1}{\tt 10} & \bitbox{2}{\tt 2002} & \bitbox{1}{\tt 0f} & \bitbox{1}{\tt 02} &
      \bitbox{1}{\tt 14}
    \end{leftwordgroup} \\
    ...
    \begin{leftwordgroup}{\tiny\bfseries 20}
      \bitbox{1}{\tt 11} & \bitboxes*{1}{{$D$} {\tt 01} {$S_r$} {\tt 01}} & \bitbox{1}{\tt 01}
...
\begin{figure}
  ...
  \end{bytefield}
  \caption{Render Menu request message (TODO: redo)}
...
\begin{figure}
  ...
  \end{bytefield}
  \caption{Menu footer message (TODO: redo)}
...
\begin{figure}
  ...
  \end{bytefield}
  \caption{Artwork request message (TODO: redo)}
