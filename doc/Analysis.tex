...
\begin{figure}
  \begin{bytefield}[bitwidth=1.9em, leftcurly=., leftcurlyspace=0pt]{16}
    ...
    \begin{leftwordgroup}{\tiny 0} % 0x00
      ...
      \bitboxes*{1}{{\tt 11} {\tt 87} {\tt 23} {\tt 49} {\tt ae} {\tt 11}} & \bitboxes*{1}{{\tt ff} {\tt ff}
        {\tt ff} {\tt fe}} & \bitboxes*{1}{{\tt 10} {\tt 00} {\tt 00} {\tt 0f} {\tt 01} {\tt 14}}
    \end{leftwordgroup} \\
    ...
    \begin{leftwordgroup}{\tiny 32} % 0x20
      \bitboxes*{1}{{\tt 11} {\tt 00} {\tt 00} {\tt 00}} & \bitbox{1}{$D$} & \bitbox[]{11}{}
    \end{leftwordgroup} \\
...
contains the track's artwork ID. More details about that will be
written once I have implemented artwork loading. In the mean time, you
can take a look at Evan's
implementation.\footnote{\url{https://github.com/EvanPurkhiser/prolink-go/blob/master/remotedb.go}}
