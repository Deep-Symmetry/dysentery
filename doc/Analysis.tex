...
\begin{center}
  \begin{longtabu}{rl}
    ...
    \bottomrule \\
    \multicolumn{2}{c}{Known Menu Item Types}
    \endfoot
...
\begin{center}
  \begin{tabu}{rcX}
    ...
    1 & {\tt 0x704} & Title and Artist sorted by title \\

    2 & {\tt 0x704} & Title and Artist sorted by artist \\

    3 & {\tt 0x204} & Sorted by album, Arg 1 holds album ID, Label 2 holds album name \\

    4 & {\tt 0xd04} & Sorted by BPM, Arg 1 holds BPM$\times$100, Label 2 empty \\

    5 & {\tt 0xa04} & Sorted by rating, Arg 1 holds rating, Label 2 empty \\

    6 & {\tt 0x604} & Sorted by genre, Arg 1 holds genre ID, Label 2 holds genre name \\

    7 & {\tt 0x2304} & Sorted by comment, Arg 1 holds comment ID, Label 2 holds comment \\

    8 & {\tt 0xb04} & Sorted by time, Arg 1 holds track length in seconds, Label 2 empty \\

    9 & {\tt 0x2904} & Sorted by remixer, Arg 1 holds remixer ID, Label 2 holds remixer \\

    10 & {\tt 0xe04} & Sorted by label, Arg 1 holds label ID, Label 2 holds label \\

    11 & {\tt 0x2804} & Sorted by original artist, Arg 1 holds original artist ID, Label 2 holds original artist \\

    12 & {\tt 0xf04} & Sorted by key, Arg 1 holds key ID, Label 2 holds key text \\

    13 & {\tt 0x1004} & Sorted by bit rate, Arg 1 holds bit rate, Label 2 empty \\

    16 & {\tt 0x2a04} & Sorted by DJ play count, Arg 1 holds play count, Label 2 empty \\

    17 & {\tt 0x2e04} & Sorted by date added, Arg 1 holds date ID, Label 2 holds date text \\
