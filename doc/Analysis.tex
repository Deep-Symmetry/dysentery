...
slot. $t_r$ may be an indicator of whether the track came from
rekordbox: It seems to have the value {\tt 00} when no track is
loaded, {\tt 01} when a rekordbox track is loaded, and {\tt 05} when a
regular audio CD is loaded.
